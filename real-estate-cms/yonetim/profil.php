              ...
              <form action="islemler/duzenle.php" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <img style="width:200px; height: 200px;" src="dosyalar/resimler/yonetmen/<?php echo $yonetmen_resimyol; ?>" alt="">
                    <?php } else { ?>
                    <img style="width:200px; height: 200px;" src="dosyalar/resimler/yonetmen/fotoyok.png" alt="">
                    <?php } ?>
