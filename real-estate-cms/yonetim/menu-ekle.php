                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-sm-3 col-xs-12">
                    <select class="select2_single form-control" name="menu_ust" required="" tabindex="-1">
                      ...
                      <option value="0">Yeni Üst Menü<option>
                       <?php while ($menucek=$menusor->fetch(PDO::FETCH_ASSOC)) { extract($menucek); ?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" name="menu_link" placeholder="Menü  link giriniz..." class="form-control col-md-7 col-xs-12" ">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <textarea class="ckeditor" id="editor1" required="" name="menu_detay"></textarea>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                     ...
                     <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="text" name="menu_sira" value="0" required="required" class="form-control col-md-7 col-xs-12" ">
                    </div>
                  </div>          
                  ...
                  <div align="right" class="form-group">
                    <div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-3">
                     <button type="submit" name="menu-ekle" style="font-weight:bolder;" class="btn btn-success">
