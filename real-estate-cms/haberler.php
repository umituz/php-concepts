						...
						<div class="col-md-12">
							<span class="thumb-info thumb-info-side-image thumb-info-no-zoom mt-xl">
								<span class="thumb-info-side-image-wrapper p-none">
									<a title="" href="haber-<?= seo($icerikcek['icerik_ad']).'-'.$icerikcek['icerik_id'] ?>">
										<img title="<?php echo $icerik_ad; ?>" src="dosyalar/resimler/icerik/<?php echo $icerik_resimyol; ?>" class="img-responsive" alt="<?php echo $icerik_ad; ?>" style="width: 250px; height: 150px;">
									</a>
								</span>
								
								<span class="thumb-info-caption-text">
									<h4 class="mb-md mt-xs"><a title="" class="text-dark" href="#"><?php echo $icerik_ad; ?></a></h4>
									<p class="font-size-md"><?php echo substr($icerik_detay,0,50); ?>...</p>
