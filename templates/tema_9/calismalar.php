    ...
    <div id="tf-works">
        <div class="container">
            <div class="section-header">
                <h2>BU ÇALIŞMALAR Bİ <span class="highlight"><strong>EFSANE</strong></span></h2>
            ...
            <div class="text-center">
                <ul class="list-inline cat"> <!-- Portfolio Filter Categories -->
                    ...
                    <li><a href="#" data-filter=".brand">Yapay Zeka</a></li>
                    <li><a href="#" data-filter=".app">Uygulamalar</a></li>
                    <li><a href="#" data-filter=".others">Diğerleri </a></li>
