  ...
  <div class="line">
   ...
   <div class="margin">
    ...
    <div class="s-12 m-12 l-4 margin-bottom right-align">
     ...
     <address>
      <p><strong>Adres :</strong> <?php echo $ayarcek['ayar_adres']; ?></p>
      <p><strong>Bölge:</strong> <?php echo $ayarcek['ayar_ilce']; ?> / <?php echo $ayarcek['ayar_il']; ?></p>
      <p><strong>E-posta:</strong> <?php echo $ayarcek['ayar_mail']; ?></p>
    </address>
    <br />
    <h3>Sosyal Medya Hesapları</h3>
    <p>
      <i class="icon-facebook icon"></i> <a href="<?php echo $ayarcek['ayar_facebook']; ?>">Facebook</a>
    </p>
    <p class="margin-bottom">
    <i class="icon-twitter icon"></i> <a href="<?php echo $ayarcek['ayar_twitter']; ?>">Twitter</a>
    </p>
  </div>
  <div class="s-12 m-12 l-5">
    <h3>İletişime Geç</h3>
    <form class="customform" action="">
      <div class="s-12"><input name="" placeholder="E-posta adresiniz" title="E-posta adresiniz" type="text" /></div>
      <div class="s-12"><input name="" placeholder="Adınız" title="Adınız" type="text" /></div>
      <div class="s-12"><textarea placeholder="Mesajınız" name="" rows="5"></textarea></div>
      <div class="s-12 m-12 l-4"><button class="color-btn" type="submit">Gönder</button></div>
    </form>
  </div>                
</div>
</div>
