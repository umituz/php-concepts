        		...
        		<div class="row">
        			...
        			<div class="col-md-7 contact-form wow animated fadeInLeft">
        				<form action="#" method="post">
        					<div class="input-field">
        						<input type="text" name="name" class="form-control" placeholder="Tam adınız...">
        					</div>
        					<div class="input-field">
        					...
        					<div class="input-field">
        						<textarea name="message" class="form-control" placeholder="İletmek istdiğiniz mesaj..."></textarea>
        					</div>
        			...
        			<div class="col-md-5 wow animated fadeInRight">
        				<address class="contact-details">
        					<h3>İletişime Geç</h3>						
        					<p><i class="fa fa-pencil"></i> <?php echo $ayarcek['ayar_adres']; ?> </span><span><?php echo $ayarcek['ayar_ilce']; ?> / <?php echo $ayarcek['ayar_il']; ?></span></p><br>
        					<p><i class="fa fa-phone"></i>Telefon: <?php echo $ayarcek['ayar_tel']; ?> </p>
        					<p><i class="fa fa-envelope"></i><?php echo $ayarcek['ayar_mail']; ?></p>
        				</address>
        			</div>
