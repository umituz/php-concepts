            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="scroll"><a href="#features">Özellikler</a></li>
                        ...
                        <li class="scroll"><a href="#meet-team">Ekip</a></li>
                        <li class="scroll"><a href="#pricing">Ücretlendirme</a></li>
                        <li class="scroll"><a href="#blog">Blog</a></li> 
                        <li class="scroll"><a href="#get-in-touch">İletişim</a></li>                        
                    </ul>
                </div>
            </div><!--/.container-->
        </nav><!--/nav-->
