...
$HesaplaBir		=	atan($SayiBir);
$HesaplaIki		=	atan($SayiIki);
$HesaplaUc		=	atan($SayiUc);

echo $SayiBir . " sayısının ark tanjantını radyan değeri : " . $HesaplaBir . "<br />";
echo $SayiIki . " sayısının ark tanjantını radyan değeri : " . $HesaplaIki . "<br />";
echo $SayiUc . " sayısının ark tanjantını radyan değeri : " . $HesaplaUc;
