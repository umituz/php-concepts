...
$DizininEnKucukElemani	=	max($RakamlarBir);

echo "Yukarıdaki dizinin en büyük eleman değeri : " . $DizininEnKucukElemani . "<br /><br />";

$RakamlarIki	=	max(5, 6, 72, 3, 83, 82, 55,905, 12, 52);

echo "Değişkenin en büyük eleman değeri : " . $RakamlarIki . "<br /><br />";
