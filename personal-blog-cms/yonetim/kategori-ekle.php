            ...
            <div class="x_content">
              ...
              <form action="islemler/ekle.php" method="post" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Eklenme Tarihi
                  ...
                  <div class="col-md-3 col-sm-3 col-xs-12">
                    <input type="date" name="kategori_tarih" value="<?php echo date('Y-m-d'); ?>" required="required" class="form-control col-md-7 col-xs-12" ">
                  </div>
                  <div class="col-md-2 col-sm-2 col-xs-12">
                    <input type="time" name="kategori_saat" value="<?php echo date('H:i:s'); ?>" required="required" class="form-control col-md-7 col-xs-12" ">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <textarea class="ckeditor" id="editor1" required="" name="kategori_detay"></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                 ...
                 <div class="col-md-9 col-sm-9 col-xs-12">
                  <input type="text" name="kategori_keywords" placeholder="Kategori anahtar kelimelerini giriniz..." required="required" class="form-control col-md-7 col-xs-12" ">
                </div>
              </div>          
              ...
              <div align="right" class="form-group">
                <div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-3">
                 <button type="submit" name="kategori-ekle" style="font-weight:bolder;" class="btn btn-success">
