              ...
              <form action="islemler/duzenle.php" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <img style="width:375px; height: 175px;" src="upload/resim/logo/<?php echo $ayar_logo; ?>" alt="">
                    <?php } else { ?>
                    <img style="width:375px; height: 175px;" src="upload/resim/logo/logoyok.png" alt="">
                    <?php } ?>
               ...
               <form action="islemler/duzenle.php" method="post" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Site Mail Adresi
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="ayar_sitemail"  value="<?php echo $ayar_sitemail; ?>" class="form-control col-md-7 col-xs-12">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Site Tema
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <select id="heard" class="form-control" name="ayar_tema" required>
                    <option>Bir Tema Seçin</option>
                      <?php 
                      $klasor = opendir("C:\AppServ\www/tayfun/yonetim/tema");
